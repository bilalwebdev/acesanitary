...
class SeriesController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Series';

        // module name
        $this->module_name = 'series';

        // directory path of the module
        $this->module_path = 'series';

        // module icon
        $this->module_icon = 'c-icon cil-people';

        // module model name, path
        $this->module_model = "App\Models\Series";
    }
    ...
    public function import()
    {
        ...
        return view("backend.series.import", compact('module_title', 'module_name', 'module_icon', 'module_action', 'module_name_singular'));
    }
    ...
    {
        $series->delete();
        flash("<i class='fas fa-check'></i> Series Deleted Successfully")->success()->important();
        return redirect('admin/series/index');
    }
    public function downloadFile(Request $request)
    {
        $filePath = public_path('import-samples/series-sample.csv');
