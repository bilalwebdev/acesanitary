    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Ace Sanitary App', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
                ...
                'class' => '', // any class for input
                'value' => '<a href="https://virtina.com" target="_blank">Built with ♥ from Virtina</a>', // default value if you want
            ],
            [
    ...
    'email' => [
        ...
        'elements' => [
            [
                ...
                'class' => '', // any class for input
                'value' => 'harshal@virtina.com', // default value if you want
            ],
        ],
    ...
    'meta' => [
        ...
        'elements' => [
            [
                ...
                'class' => '', // any class for input
                'value' => 'Awesome App | A Ace Sanitary Middleware', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, Laravel,Laravel starter,Bootstrap,Admin,Template,Open,Source,harshal', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '454545454545454', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
                ...
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '@hdhingra', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
