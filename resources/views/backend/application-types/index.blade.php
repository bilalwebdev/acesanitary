        ...
        <div class="card-body">
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    ...
                    {{-- <a class="btn btn-info btn-md" href="{{ route('backend.hose-size.import') }}" data-toggle="tooltip" title="{{__('Import')}} {{ ucwords(Str::singular($module_name)) }}">  <i class="fas fa-upload"></i></a> --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            @can('edit_' . $module_name)
                                                <x-buttons.edit
                                                    route="{{ route('backend.application-types.edit', $type->id) }}"
                                                    title="{{ __('Edit') }} {{ ucwords(Str::singular($module_name)) }}"
                                                    small="true" />
                                            @endcan
                                            <x-buttons.show
                                                route="{{ route('backend.application-types.show', $type->id) }}"
            ...
            <div class="row">
                <div class="col-7">
                    <div class="float-left">
                        {{ count($app_types) }} {{ __('labels.backend.total') }}
                    </div>
                </div>
                <div class="col-5">
                    <div class="float-end">
