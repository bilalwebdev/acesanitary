    ...
    <div class="card">
        <div class="card-body">
            <x-backend.section-header>
                ...
                <x-slot name="toolbar">
                    <a class="btn btn-info btn-md" href="{{ route('backend.series.import') }}" data-toggle="tooltip"
            ...
            <div class="row mt-4">
                <div class="col">
                    <table class="table table-hover table-responsive-sm">
                        ...
                        @endforeach
                    @else
                        <span class="font-semibold p-3 text-red-900 bg-red-200 rounded-md flex justify-start items-start"
                            role="alert">No
                            Data Found!
                        </span>
                        @endif
